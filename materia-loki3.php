...
<body>
    ...
    <div class="container-fluid">
        <main>
            <div class="row">
                <h1 id="topo" class="nommat">Quais são os poderes do Loki, o Deus da trapaça?</h1>
                <article class="col-xs-10 col-sm-12 col-md-12 col-lg-9">

                    <p class="ppmat">Mesmo que não sejam poderes chamativos e extravagantes, Loki conta com muitas habilidades incríveis no MCU</p>

                    <p class="ppmat">Os poderes de Loki (Tom Hiddleston) se diferenciam bastante de Thor (Chris Hemsworth) e de qualquer outro personagem do MCU. Enquanto alguns heróis contam com habilidades extravagantes e chamativas, o Deus da Trapaça aproveita a ilusão e enganação para atingir os objetivos.</p>

                    <p class="ppmat">Com a nova série do Disney+, Loki, muitos fãs ficaram na dúvida sobre quais e quantos são os verdadeiros poderes do feiticeiro, os quais somam 17 ao todo.</p>

                    <p class="ppmat">Mudança de forma, hipnose, telepatia, teletransporte, ilusões e levitação são apenas os poderes mais básicos. Loki tem a capacidade de realizar a projeção astral, podendo lançar projeções ou até mesmo aparecer em um lugar distante. Além disso, consegue ocultar sua presença, o que não o torna invisível, mas o mascara, possibilitando-o espionar os outros.</p>
