...
<body>
    ...
    <div class="container-fluid">
        <main>
            <div class="row">
                <h1 id="topo" class="nommat">Tom Hiddleston comenta bissexualidade de Loki</h1>
                <article class="col-xs-10 col-sm-12 col-md-12 col-lg-9">

                    <p class="ppmat">Nos últimos anos, a Marvel tem trabalhado de forma a tornar os seus filmes e personagens o mais diversificadas e inclusivas possíveis, dando destaque a minorias menos representadas no mundo audiovisual.</p>

                    <p class="ppmat">Uma dessas personagens é Loki que, na sua série do Disney+, revelou que tinha interesse por príncipes e princesas, confirmando assim que é bissexual.
                    </p>

                    <p class="ppmat">Agora, Tom Hiddleston (o ator que o interpreta) dá a sua opinião a respeito da orientação sexual de Loki numa entrevista ao The Guardian. Quando questionado sobre a transição do grande para o pequeno ecrã, Hiddleston respondeu o seguinte:</p>
