...
<body>
    ...
    <Header class="headerDoninha row">
        <img class="img-fluid" src="images/superchoquebanner.jpg" alt="Imagem do personagem Super Choque voando com seus raios e a o fundo está a cidade">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12 col-xl-8 float-xl-start">
                <article>
                    ...
                    <div class="row">
                        ...
                        <img class="col-12 col-sm-6 col-md-6 pb-5" src="images/superchoque2.png" alt="Imagem do Super Choque voando ">

                        <img class="col-12 col-sm-6 col-md-6 pb-5" src="images/superchoque1.jpg" alt="imagem do Super Choque em sua identidade secreta Virgil junto de seu amigo Gear">
                    ...
                    <div>
                        ...
                        <object class="col-12 col-sm-12 col-md-12 col-lg-6 pb-5 px-md-1 float-lg-start videoDoninha" data="https://www.youtube.com/embed/L_f1L1YL_pg">Link do vídeo a abertura do seriado do super choque</object>

                        <object class="col-12 col-sm-12 col-md-12 col-lg-6 pb-5 px-md-1  videoDoninha" data="https://www.youtube.com/embed/in8c2tvxU9U">Link para um trecho de um episódio da série</object>
                    </div>
                    ...
                    <img class="col-12 pb-5" src="images/superchoque3.jpeg" alt="imagem do personagem Super Choque em três versões">
            ...
            <footer class="BotaoVoltarAoTopo row">
                <button onclick="window.location.href='superchoque.php#topo';" class="col-5 btn btn-dark justify-content-center">Voltar ao Topo</button>
            </footer>
        </div>
