...
<body>
    ...
    <div class="container-fluid">
        <main>
            <div class="row">
                <h1 id="topo" class="nommat">Loki: Série terá novo roterista principal na segunda temporada</h1>
                <article class="col-xs-10 col-sm-12 col-md-12 col-lg-9">

                    <p class="ppmat">As séries em streaming do MCU conquistaram parte do público, mas poucas geraram tamanha comoção como Loki. A produção focada no Deus da Trapaça prometia afetar todo o multiverso e, com isso, atraiu os olhares de muita gente. Com isso, o projeto acabou garantindo uma segunda temporada — que, segundo o roteirista Michael Waldron, contará com um novo comandante no departamento dos roteiros.</p>

                    <p class="ppmat">Em entrevista ao DigitalSpy, Waldron foi questionado sobre a relação entre a série e o novo filme do Doutor Estranho, já que escreveu para ambos. Apesar de dar uma resposta vaga sobre conexões, ele comentou sobre a equipe por trás do projeto do Disney+, além de revelar a mudança de roteirista principal. Ele disse:</p>

                    <p class="ppmat">“Bom, quer dizer, veja, tudo meio que leva para tudo, certo?” Waldron comentou. “Nós contratamos alguns ótimos diretores. [Justin] Benson e [Aaron] Moorhead são brilhantes. E Eric Martin assumiu como roteirista principal para a temporada 2. Então a equipe criativa é fantástica. Como Tom [Hiddleston] disse uma vez, tem muito mais travessuras por vir.”</p>
                        ...
                        <div class="col-md-6 col-lg-12 float-start">
                            <div class="card">
                                <section class="sec3">
                                    ...
                                    <a href="materia-loki.php" class="btn btn-primary buttonm">Saiba mais</a>
                                </section>
                            </div>
                        </div>
