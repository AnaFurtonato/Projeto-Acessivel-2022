...
<body>
    ...
    <Header class="headerDoninha row">
        <img class="img-fluid" src="images/Grootbanner.jpg" 
            alt="Imagem do rosto do personagem Baby Groot e na frente a logo escrito I'm Groot">
            ...
            <div class="col-12 col-lg-12 col-xl-8 float-xl-start">
                <article>
                    ...
                    <div class="row">
                        ...
                        <img class="col-12 col-sm-6 col-md-6 pb-5" src="images/groothq.webp"
                            alt="Imagem do Baby Groot no filme">

                        <img class="col-12 col-sm-6 col-md-6 pb-5" src="images/groot1.jpg"
                        alt="imagem do Baby Groot em quadrinho atrás de uma borboleta.">
                    ...
                    <div>
                        ...
                        <object class="col-12 col-sm-12 col-md-12 col-lg-6 pb-5 px-md-1 float-lg-start videoDoninha"
                            data="https://www.youtube.com/embed/y0y5tnzzM8I">Link parte do filme onde aparece a morte de Groot.</object>

                        <object class="col-12 col-sm-12 col-md-12 col-lg-6 pb-5 px-md-1  videoDoninha"
                            data="https://www.youtube.com/embed/1jaocSs-OWg">Link para um trecho do filme Guardiões da Galáxia 2 onde Baby Groot aparece.</object>
                    </div>
                    ...
                    <img class="col-12 pb-5" src="images/grootfilme.jpg"
                        alt="imagem do Groot adulto e do Baby Groot quando pequeno">
            ...
            <aside class="col-sm-12 col-md-12 col-lg-12 col-xl-4 ">
                ...
                <div class="row">
                    ...
                    <div class=" pb-5 float-sm-start float-lg-none col-md-6 row-col-lg-6 col-xl-12">
                        <img class="col-12 col-sm-12 col-md-12" src="images/babygroot390x194.jpg"
                            alt="Imagem do Baby Groot quadrinho lado esquerdo e filme lado direito">
                    ...
                    <div class="pb-5 col-md-6 float-sm-end col-lg-6 col-xl-12">
                        <img class="col-12 col-sm-12 col-md-12" src="images/super-choque.jpg"
                            alt="Imagem do personagem Super choque">
